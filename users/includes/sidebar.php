<aside>
    <div id="sidebar" class="nav-collapse " style="background: #4f4e48;">
        <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li style="background: #33322e; padding-bottom: 9px; border-radius: 4px 4px 0 0"><a href="profile.php">Profile</a></li>
                    <li style="background: #33322e; border-top: #807f7c 0.2px solid"><a href="change-password.php">Change Password</a></li>
                </ul>
            </li>
            <li class="sub-menu">
